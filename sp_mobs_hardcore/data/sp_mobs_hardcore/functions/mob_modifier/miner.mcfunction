execute if predicate spm_api:1/3 run item modify entity @s armor.head spm_api:enchant_with_level/10
execute if predicate spm_api:1/3 run item modify entity @s armor.chest spm_api:enchant_with_level/10
execute if predicate spm_api:1/4 run item modify entity @s armor.legs spm_api:enchant_with_level/10
