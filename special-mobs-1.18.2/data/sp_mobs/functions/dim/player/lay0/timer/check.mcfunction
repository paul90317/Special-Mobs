execute unless score @s spm.p.sslot matches 0 run function sp_mobs:dim/player/sslot
...
execute if entity @s[scores={spm.p.dur=..0}] run function sp_mobs:dim/player/lay0/timer/out
