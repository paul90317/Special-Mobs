...
execute if entity @s[scores={spw.temp=3..}] run effect give @s resistance 4 2
execute if entity @s[scores={spw.temp=0..1}] run effect give @a[distance=..3] absorption 8 0
execute if entity @s[scores={spw.temp=2}] run effect give @a[distance=..4] absorption 8 0
execute if entity @s[scores={spw.temp=3..}] run effect give @a[distance=..5] absorption 8 1
