data merge entity @s {CustomName:'{"text":"ninja","color":"white"}',DeathLootTable:"sp_mobs:spm/ninja",ArmorItems:[{Count:1b,id:"minecraft:leather_boots",tag:{display:{color:1908001}}},{Count:1b,id:"minecraft:leather_leggings",tag:{display:{color:1908001}}},{Count:1b,id:"minecraft:leather_chestplate",tag:{display:{color:1908001}}},{Count:1b,id:"minecraft:stripped_oak_log"}],HandItems:[{Count:1,id:"bow"},{}]}
