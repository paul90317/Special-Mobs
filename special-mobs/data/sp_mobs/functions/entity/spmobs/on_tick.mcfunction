...
execute if entity @s[tag=sp_mob.warp_enderman] run function sp_mobs:entity/spmobs/do/warp_enderman
execute if entity @s[tag=sp_mob.fire_knight] run function sp_mobs:entity/spmobs/do/fire_knight
execute if entity @s[tag=sp_mob.skeleton_lord] run function sp_mobs:entity/spmobs/do/skeleton_lord/do
execute if entity @s[tag=sp_mob.soul_falcon] run function sp_mobs:entity/spmobs/do/soul_falcon
execute if entity @s[tag=sp_mob.crimson_aboriginal] run function sp_mobs:entity/spmobs/do/crimson_aboriginal/do
...
execute if entity @s[tag=sp_mob.black_widow] run particle minecraft:nautilus ~ ~0.3 ~ 0 0 0 1.0 2
